...
const en = {
    message: {
        ...
        tk: 'Travel Kit',
        mc: 'More Categories',
        homeQmDesc: 'Yier has a professional team of R&D, Mold design and make, injection, silk screen printing, hot stamping, assembling. We also have relative modern machine and we produce with ISO9001 quality management system.',
        homeN1T: 'Thailang Bangkok Beauty Exhibition Bangkok IMPACT Exhibition Center',
        homeN1D: 'Booth No.P34, 2019/09/19-2019/09/21',
        homeN2T: '2019 ASIA HONG KONG ASIAWORLD-EXPO',
        homeN2D: 'BOOH NO.11-E30, 2019/11/12-2019/11/14',
        homeN3T: 'Bed',
        homeN3D: 'I should go to bed',
        foot: {
            address: 'Address： fengHui industrial zone, shangyu, zhejiang, China',
            right: 'Copyright © 2018 Shaoxing Shangyu Yier Plastics Co., Ltd. All Rights Reserve'
        },
        telphone: 'Telphone:',
        website: 'Website:'
    },
    ...
    qm: {
        qc: '[EN]产品检验',
        ac: '[EN]外观方面的检验，涉及到产品的注塑外形制作工艺的电镀油漆颜色是否到位，有无瑕疵，丝印LOGO是否完整等等，主要体现在用户视觉满意度上。',
        fc: '[EN]功能性的检验，包括产品各部件之间的配合是否到位顺畅，细节是否完善，产品密封性安全性等等，这一部分主要体现在用户使用满意度上，至关重要。'
    },
    ...enLocale
}
